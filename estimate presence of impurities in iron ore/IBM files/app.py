...
API_KEY = "me4XrR8YB5elR-R4UDflAJZATxDi-ZhEeK9uM-0EomCu"
...
def y_predict():
    ...
    response_scoring = requests.post('https://eu-de.ml.cloud.ibm.com/ml/v4/deployments/7504ac39-eb03-4fcf-86b7-22c6deb948c0/predictions?version=2022-03-29', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
